/**
    ...
    8 reads are performed simultaneously (this value has been chosen as a trade off between
...
channel {{ helper.type_str }} {{ channels["channel_out_matrix"] }} __attribute__((depth({{ helper.width_y }})));
{% endif %}
