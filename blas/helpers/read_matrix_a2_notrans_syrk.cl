...
__kernel void READ_MATRIX_A2(__global volatile TYPE_T * restrict A, const unsigned int N, const unsigned int K, const unsigned int lda, const unsigned int lower)
{
