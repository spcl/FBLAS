/**
    ...
    into CHANNEL_MATRIX_B. This helper can be used in SYR2K routine
    ...
    Each tile-row ti of B is sent a  different number of time, depending on the
    type of SYRK computation:
    - if C is lower triangular, it will be sent ti times
    - if C is upper triangular, it will be sent NumTile-times
...
__kernel void READ_MATRIX_B2(__global volatile TYPE_T * restrict B, const unsigned int N, const unsigned int K, const unsigned int ldb, unsigned int lower)
{
