...
__kernel void {{ helper_name }}(__global volatile {{ helper.type_str }} * restrict A, const unsigned int N, const unsigned int K, const unsigned int lda, unsigned int lower)
{
